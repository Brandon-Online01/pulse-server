...
exports.LicenseActivated = exports.LicenseSuspended = exports.LicenseRenewed = exports.LicenseLimitReached = exports.LicenseUpdated = exports.LicenseCreated = exports.OrderWarehouseFulfillment = exports.OrderInternalNotification = exports.OrderResellerNotification = exports.DailyReport = exports.OrderDelivered = exports.OrderOutForDelivery = exports.PasswordChanged = exports.Invoice = exports.NewOrderReseller = exports.NewOrderInternal = exports.NewOrder = exports.PasswordReset = exports.Verification = exports.Signup = void 0;
...
exports.NewOrderInternal = NewOrderInternal;
const NewOrderReseller = (data) => {
    return `
    <div style="${BASE_STYLES?.wrapper}">
      <div style="${BASE_STYLES?.container}">
        <div style="${BASE_STYLES?.header}">
...
exports.NewOrderReseller = NewOrderReseller;
const Invoice = (data) => {
    return `
    <div style="${BASE_STYLES?.wrapper}">
      <div style="${BASE_STYLES?.container}">
...
const OrderOutForDelivery = (data) => {
    return `
    <div style="${BASE_STYLES?.container}">
      <div style="${BASE_STYLES?.header}">
...
exports.OrderOutForDelivery = OrderOutForDelivery;
...
const OrderResellerNotification = (data) => {
    return `
    <div style="${BASE_STYLES?.wrapper}">
      <div style="${BASE_STYLES?.container}">
        <div style="${BASE_STYLES?.header}">
...
exports.OrderResellerNotification = OrderResellerNotification;
const OrderInternalNotification = (data) => {
    return `
    <div style="${BASE_STYLES?.wrapper}">
      <div style="${BASE_STYLES?.container}">
        <div style="${BASE_STYLES?.header}">
        ...
        data?.priority === 'medium' ? '#ffc107' : '#28a745'}">${data?.priority?.toUpperCase()}</span>
                </div>
                <div style="display: flex; justify-content: space-between;">
...
exports.OrderInternalNotification = OrderInternalNotification;
const OrderWarehouseFulfillment = (data) => {
    return `
    <div style="${BASE_STYLES?.wrapper}">
      <div style="${BASE_STYLES?.container}">
        <div style="${BASE_STYLES?.header}">
...
exports.OrderWarehouseFulfillment = OrderWarehouseFulfillment;
const LicenseCreated = (data) => `
    <div style="${BASE_STYLES.wrapper}">
      <div style="${BASE_STYLES.container}">
        <div style="${BASE_STYLES.header}">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="white">
            ...
            <div style="${BASE_STYLES.highlight}">
              <div style="display: grid; gap: 12px;">
                ...
                <div style="display: flex; justify-content: space-between;">
                  ...
                  <span style="font-weight: 600">${(0, date_utils_1.formatDate)(data.validUntil)}</span>
                </div>
              </div>
            </div>
...
`;
exports.LicenseCreated = LicenseCreated;
const LicenseUpdated = (data) => `
    <div style="${BASE_STYLES.wrapper}">
      <div style="${BASE_STYLES.container}">
        <div style="${BASE_STYLES.header}">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="white">
...
`;
exports.LicenseUpdated = LicenseUpdated;
const LicenseLimitReached = (data) => `
    <div style="${BASE_STYLES.wrapper}">
      <div style="${BASE_STYLES.container}">
        <div style="${BASE_STYLES.header}">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="white">
...
`;
exports.LicenseRenewed = LicenseRenewed;
const LicenseSuspended = (data) => `
    <div style="${BASE_STYLES.wrapper}">
      <div style="${BASE_STYLES.container}">
        <div style="${BASE_STYLES.header}">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="white">
          ...
          <div style="${BASE_STYLES.card}">
            ...
            <div style="${BASE_STYLES.alert}">
              <div style="display: grid; gap: 12px;">
                ...
                <div style="display: flex; justify-content: space-between;">
                  <span>Valid Until</span>
                  <strong>${(0, date_utils_1.formatDate)(data.validUntil)}</strong>
                </div>
              </div>
            </div>
...
`;
exports.LicenseSuspended = LicenseSuspended;
const LicenseActivated = (data) => `
    <div style="${BASE_STYLES.wrapper}">
      <div style="${BASE_STYLES.container}">
        <div style="${BASE_STYLES.header}">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="white">
