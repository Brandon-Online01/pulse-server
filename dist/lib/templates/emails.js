...
exports.TaskReminderCreator = exports.TaskReminderAssignee = exports.TaskUpdated = exports.NewTask = exports.LicenseActivated = exports.LicenseSuspended = exports.LicenseRenewed = exports.LicenseLimitReached = exports.LicenseUpdated = exports.LicenseCreated = exports.DailyReport = exports.Invoice = exports.NewQuotationReseller = exports.NewQuotationInternal = exports.NewQuotationClient = exports.PasswordChanged = exports.PasswordReset = exports.Verification = exports.Signup = void 0;
...
exports.NewQuotationClient = NewQuotationClient;
const NewQuotationInternal = (data) => {
    const itemsList = data.quotationItems.map(item => `
    <tr>
      <td style="padding: 12px; border-bottom: 1px solid #e2e8f0;">${item.quantity}x</td>
...
exports.NewQuotationInternal = NewQuotationInternal;
const NewQuotationReseller = (data) => {
    const itemsList = data.quotationItems.map(item => `
    <tr>
      <td style="padding: 12px; border-bottom: 1px solid #e2e8f0;">${item.quantity}x</td>
      <td style="padding: 12px; border-bottom: 1px solid #e2e8f0;">${item.product.uid}</td>
...
exports.NewQuotationReseller = NewQuotationReseller;
const Invoice = (data) => {
    return `
    <div style="${BASE_STYLES?.wrapper}">
      <div style="${BASE_STYLES?.container}">
...
const DailyReport = (data) => {
    const { name, date, metrics: { xp, attendance, totalQuotations, totalRevenue, newCustomers, quotationGrowth, revenueGrowth, customerGrowth, userSpecific, }, tracking, } = data;
    const xpSection = xp ? `
    <div style="${BASE_STYLES.card}">
