...
export class TasksController {
  ...
  @ApiQuery({ name: 'isOverdue', type: String, required: false, description: 'Filter by overdue status (true/false)' })
  ...
  @ApiQuery({ name: 'date', type: String, required: false, description: 'Date for which to retrieve routes (ISO format), defaults to current date' })
  @ApiOkResponse({ 
  ...
  @ApiQuery({ name: 'date', type: String, required: false, description: 'Date for which to calculate routes (ISO format), defaults to current date' })
  @ApiOkResponse({ 
